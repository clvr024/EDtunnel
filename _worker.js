...
export default {
	 ...
	 * @param {{UUID: string, พร็อกซีไอพี: string, DNS_RESOLVER_URL: string, NODE_ID: int, API_HOST: string, API_TOKEN: string, HOSTNAME: string}} env
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const randomHostname = env.HOSTNAME || cn_hostnames[Math.floor(Math.random() * cn_hostnames.length)];
